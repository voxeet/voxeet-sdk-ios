...
SWIFT_CLASS("_TtC9VoxeetSDK7VTFiles")
@interface VTFiles : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
...
/// \param fail A block object to be executed when the server connection sequence ends. This block has no return value and takes a single <code>NSError</code> argument that indicates whether or not the connection to the server succeeded.
///
- (void)convertFileWithPath:(NSURL * _Nonnull)path progress:(void (^ _Nullable)(double))completionProgress success:(void (^ _Nullable)(NSDictionary<NSString *, id> * _Nullable))successCompletion fail:(void (^ _Nullable)(NSError * _Nonnull))failCompletion;
...
/// \param completion A block object to be executed when the server connection sequence ends. This block has no return value and takes a single <code>NSError</code> argument that indicates whether or not the connection to the server succeeded.
///
- (void)startPresentationWithFileID:(NSString * _Nonnull)fileID filename:(NSString * _Nonnull)filename page:(NSInteger)page pageCount:(NSInteger)pageCount completion:(void (^ _Nullable)(NSError * _Nullable))completion;
...
/// \param completion A block object to be executed when the server connection sequence ends. This block has no return value and takes a single <code>NSError</code> argument that indicates whether or not the connection to the server succeeded.
///
- (void)updatePresentationWithFileID:(NSString * _Nonnull)fileID page:(NSInteger)page completion:(void (^ _Nullable)(NSError * _Nullable))completion;
...
/// \param completion A block object to be executed when the server connection sequence ends. This block has no return value and takes a single <code>NSError</code> argument that indicates whether or not the connection to the server succeeded.
///
- (void)stopPresentationWithFileID:(NSString * _Nonnull)fileID completion:(void (^ _Nullable)(NSError * _Nullable))completion;
